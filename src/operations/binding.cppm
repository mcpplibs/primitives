...
export module mcpplibs.primitives.operations.binding;
...
export namespace mcpplibs::primitives::operations::binding {
...
} // namespace mcpplibs::primitives::operations::binding
